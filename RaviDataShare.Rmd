...
test <- read.csv("rsem.merged.gene_counts.tsv", sep = "\t") %>%
...
for(i in 2:ncol(test)) {
  correlations <- c(correlations, cor(fiveXFADversusRavi5XFADReference_rsem.merged.transcript_countsCollapsed[,i], test[,i]))
}
